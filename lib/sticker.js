...
const getMetadata = (msg, args, senderNumber = '') => {
    const defaultPack = String(global.botName || global.stickerPack || global.packname || 'Zapia Stickers')
    const defaultAuthor = senderNumber
        ? `@${senderNumber}`
        : String(global.stickerAuthor || global.author || global.dev || msg.pushName || 'Zapia')
