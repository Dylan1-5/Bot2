...
// Extrae el número telefónico real ignorando IDs de mensajes y formateando JIDs (@s.whatsapp.net)
const extractNumber = (input) => {
    if (!input) return ''
    
    // Si viene un JID o mención (ej: "50661410344@s.whatsapp.net" o "50661410344:12@s.whatsapp.net")
    let target = String(input).split('@')[0].split(':')[0]
